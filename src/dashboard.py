...
with col1:
    date_from = st.date_input("Date from", value=datetime.now() - timedelta(days=30), max_value=datetime.now())
with col2:
    date_to = st.date_input("Date to", value=datetime.now(), min_value=date_from, max_value=datetime.now())
